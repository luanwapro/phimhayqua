...
<html>
<head>
    <title>Thể Loại {{$tentheloai}}| Phim Hay Quá</title>
    <!-- for-mobile-apps -->
...
<div class="w3_content_agilleinfo_inner">
    <div class="agile_featured_movies">
        ...
        <!--/tv-movies-->
        <h3 class="agile_w3_title hor-t">Thể Loại<span> {{$tentheloai}}</span> </h3>
        <div class="wthree_agile-requested-movies tv-movies">
            @foreach($danhsachphim as $value)
            <div class="col-md-2 w3l-movie-gride-agile requested-movies">
                <a href="{{url('phim')}}/<?php echo vn_to_str ($value->tenphim)?>-{{$value->id_phim}}/" class="hvr-sweep-to-bottom"><img src="{{asset('')}}/{{$value->hinhanh}}" title="Movies Pro" class="img-responsive" alt=" ">
        ...
        <div class="blog-pagenat-wthree">
            ...
            <!--//requested-movies-->
            <h3 class="agile_w3_title"> Top  <span>{{$tentheloai}}</span></h3>
            <!--/movies-->
            <div class="w3_agile_latest_movies">

                <div id="owl-demo" class="owl-carousel owl-theme">

                    @foreach($topphim as $value)
                    <div class="item">
