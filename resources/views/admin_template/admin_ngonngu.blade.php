...
@section('noidung')
    ...
    @foreach($danhsachngonngu as $value)
            ...
            <div class="col-lg-6" style="width: 100%;margin-left: 25%">
                <div class="card">
                    <div class="card-header">
                        <strong>Cập Nhật Ngôn Ngữ</strong>
                    </div>
                    <div class="card-body card-block">
                        <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input name="tenupdate" class="form-control"  type="text" value="{{$value->tenloai}}"  placeholder="Vd : Phim Hành Động"><small class="help-block form-text"></small></div>
                            </div>
                            ...
                            <button class="btn btn-primary btn-sm" type="submit" style="margin-left: 60%">
                                <i class="fa fa-dot-circle-o"></i> Cập Nhật Ngôn Ngữ
                            </button>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label" for="email-input">Tên Ngôn Ngữ</label></div>
                            <div class="col-12 col-md-9"><input name="ten" class="form-control"  type="text" placeholder="Vietsub"><small class="help-block form-text"></small></div>
                        </div>
    ...
    <div class="card">
        <div class="card-header">
            <strong class="card-title">Danh Sách Ngôn Ngữ</strong>
        </div>
        <div class="card-body">
            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                ...
                <tbody>
                @forelse($danhsachngonngu as $value)
                ...
                @empty
                    <td role="3">Chưa có Danh Sách Ngôn Ngữ<td>
    ...
    <script>
        ...
        function xoa() {
            ...
            $.post('',{'idloaiphimcanxoa':idloaiphim},function (data) {
                ...
                window.location="quanly/quanlyngonngu";
            });
        }
        function chinhsua() {
                    @forEach( $danhsachngonngu as $value)
