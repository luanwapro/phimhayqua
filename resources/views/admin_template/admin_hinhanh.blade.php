...
@section('noidung')
    ...
    @foreach($danhsachhinhanh as $value)
            ...
            <div class="col-lg-6" style="width: 100%;margin-left: 25%">
                <div class="card">
                    <div class="card-header">
                        <strong>Cập Nhật Link ảnh</strong>
                    </div>
                        ...
                        <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <p class="form-control-static">Link ảnh </p>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input name="linkanhupdate" class="form-control"  type="file"   ><small class="help-block form-text"></small></div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label" for="email-input">Thêm Link Ảnh</label></div>
                            <div class="col-12 col-md-9"><input name="linkanh" class="form-control"  type="file" placeholder="Vd :phim Cổ Trang"><small class="help-block form-text"></small></div>
                        </div>
    ...
    <div class="card">
        <div class="card-header">
            <strong class="card-title">Danh Sách ảnh</strong>
        </div>
        <div class="card-body">
            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                ...
                <tbody>
                @forelse($danhsachhinhanh as $value)
                ...
                @empty
                    <td role="3">Chưa có Danh Sách hình ảnh<td>
    ...
    <script>
        ...
        function xoa() {
            ...
            $.post('',{'idloaiphimcanxoa':idloaiphim},function (data) {
                ...
                window.location="quanly/quanlyhinhanh";
            });
        }
        function chinhsua() {
                    @forEach( $danhsachhinhanh as $value)
