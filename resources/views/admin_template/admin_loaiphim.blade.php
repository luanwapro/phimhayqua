...
@section('noidung')
    ...
    @foreach($danhsachloaiphim as $value)
        ...
        <div class="col-lg-6" style="width: 100%;margin-left: 25%">
            <div class="card">
                <div class="card-header">
                    <strong>Cập Nhật Loại Phim</strong>
                </div>
                    ...
                    <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <p class="form-control-static">Tên Loại Phim </p>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label" for="email-input">Tên Loại</label></div>
                            <div class="col-12 col-md-9"><input name="tenloaiphimupdate" class="form-control"  type="text" value="{{$value->tenloai}}"  placeholder="Vd : Phim Hành Động"><small class="help-block form-text"></small></div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label" for="email-input">Thêm Loại Phim</label></div>
                            <div class="col-12 col-md-9"><input name="tenloaiphim" class="form-control" id="soluongton" type="text" placeholder="Vd :phim Cổ Trang"><small class="help-block form-text"></small></div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                @forelse($danhsachloaiphim as $value)
                                ...
                                @empty
                                    <td role="3">Chưa có Danh Sách Loại Phim</td>
    ...
    <script>
        ...
        function xoa() {
            ...
            $.post('',{'idloaiphimcanxoa':idloaiphim},function (data) {
                ...
                window.location="quanly/quanlyloaiphim";
            });
        }
        function chinhsua() {
            @forEach( $danhsachloaiphim as $value)
