...
@section('noidung')
    ...
    @foreach($danhsachdaodien as $value)
            ...
            <div class="col-lg-6" style="width: 100%;margin-left: 25%">
                <div class="card">
                    <div class="card-header">
                        <strong>Cập Nhật Thông tin đạo diễn</strong>
                    </div>
                    <div class="card-body card-block">
                        <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label class=" form-control-label" for="email-input">Tên</label></div>
                                <div class="col-12 col-md-9"><input name="tendaodienupdate" class="form-control"  type="text" value="{{$value->ten}}"  placeholder="Vd : Phim Hành Động"><small class="help-block form-text"></small></div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label class=" form-control-label" for="email-input">Hình Ảnh</label></div>
                                <div class="col-12 col-md-9"><input name="anhdaodienupdate" class="form-control"  type="file" value="{{$value->hinhanh}}"  placeholder="Vd : Phim Hành Động"><small class="help-block form-text"></small></div>
                            </div>


                            <button class="btn btn-primary btn-sm" type="submit" style="margin-left: 60%">
                                <i class="fa fa-dot-circle-o"></i> Cập Nhật Thông Tin Đạo Diễn
                            </button>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label" for="email-input">Tên</label></div>
                            <div class="col-12 col-md-9"><input name="tendaodien" class="form-control"  type="text"   placeholder="Vd : Phạm Minh Luân"><small class="help-block form-text"></small></div>
                        </div>

                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label" for="email-input">Hình Ảnh</label></div>
                            <div class="col-12 col-md-9"><input name="anhdaodien" class="form-control"  type="file"   placeholder="Vd : Phim Hành Động"><small class="help-block form-text"></small></div>
                        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                ...
                <tbody>
                @forelse($danhsachdaodien as $value)
    ...
    <script>
        ...
        function xoa() {
            ...
            $.post('',{'idloaiphimcanxoa':idloaiphim},function (data) {
                ...
                window.location="quanly/quanlydaodien";
            });
        }
        function chinhsua() {
                    @forEach( $danhsachdaodien as $value)
