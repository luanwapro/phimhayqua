...
@section('noidung')
    ...
    @foreach($danhsachbinhluan as $value)
            ...
            <div class="col-lg-6" style="width: 100%;margin-left: 25%">
                <div class="card">
                    <div class="card-header">
                        <strong>Cập Nhật Bình Luân</strong>
                    </div>
                    <div class="card-body card-block">
                        <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input name="linkcmtupdate" class="form-control"  type="text" value="{{$value->link}}"  placeholder="Vd : Phim Hành Động"><small class="help-block form-text"></small></div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label" for="email-input">Thêm Bình Luân</label></div>
                            <div class="col-12 col-md-9"><input name="linkcmt" class="form-control"  type="text" placeholder="Vd :http://facebook.com/..."><small class="help-block form-text"></small></div>
                        </div>

                        <button class="btn btn-primary btn-sm" type="submit" style="margin-left: 60%">
                            <i class="fa fa-plus"></i> Thêm Bình Luân
                        </button>
                        <button class="btn btn-danger btn-sm" type="reset">
                            <i class="fa fa-ban"></i> Xóa Tất Cả
                        </button>
    ...
    <div class="card">
        <div class="card-header">
            <strong class="card-title">Danh Bình Luân</strong>
        </div>
        <div class="card-body">
            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                ...
                <tbody>
                @forelse($danhsachbinhluan as $value)
    ...
    <script>
        ...
        function xoa() {
            ...
            $.post('',{'idloaiphimcanxoa':idloaiphim},function (data) {
                ...
                window.location="quanly/quanlybinhluan";
            });
        }
        function chinhsua() {
                    @forEach( $danhsachbinhluan as $value)
